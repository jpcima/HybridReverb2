...
public:
    ...
    int readFile(const String &presetFilename, String *error);
    int save(String *error);
    int saveAs(const String &presetFile, String *error);
    int parseRoot(XmlElement *element, String *error);
...
private:
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PresetCollection)
};
